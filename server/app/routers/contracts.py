...
from ..visibility import assert_org_writable, assert_obj_org_writable, assert_patient_visible, scope_patient_list
...
def list_contracts(
    ...
    return paginate(query.order_by(FamilyDoctorContract.id.desc()), response, offset, limit)
