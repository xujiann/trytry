...
@router.post(
    "/master-cases", status_code=201, dependencies=[Depends(require_roles("doctor", "operator"))]
)
...
@router.post(
    "/master-cases/{case_id}/publish", dependencies=[Depends(require_roles("director", "doctor"))]
)
...
@router.post(
    "/simulations", status_code=201, dependencies=[Depends(require_roles("director", "doctor"))]
)
...
@router.post("/simulations/{case_id}/attempts", status_code=201)
...
@router.get("/simulations/{case_id}/attempts")
